  ...
  if (loading) {
    return (
      <div className="flex h-96 items-center justify-center">
        ...
        <span className="ml-3 text-xl font-medium">Searching Flights...</span>
      </div>
    );
  }
    ...
    <>
      <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900">
        <div className="mx-auto max-w-7xl px-6 py-12">
          <h1 className="text-5xl font-black text-white">Available Flights</h1>
          <p className="mt-3 text-lg text-white/80">
            Compare fares from Emirates, Qatar Airways, Turkish Airlines,
            Ethiopian Airlines and more.
          </p>
        </div>
      </div>
      <div className="mx-auto max-w-7xl p-6">
        {flights.length === 0 ? (
          <div className="rounded-3xl bg-white p-16 text-center shadow-sm">
            ...
            <h2 className="mt-5 text-2xl font-bold">No Flights Found</h2>
                ...
                <div className="p-6">
                  <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                    <div className="min-w-[220px]">
                      ...
                      <h3 className="text-2xl font-black">{flight.airline}</h3>
                    ...
                    <div className="min-w-[230px] text-right">
                      ...
                      <button className="mt-4 flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-green-600 to-emerald-500 px-6 py-4 font-bold text-white shadow-lg transition-all hover:scale-[1.02]">
                        Book Flight
