      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-black via-slate-950 to-slate-900 py-32 text-white">
        ...
        <div className="container-custom relative">
          ...
          <div className="max-w-5xl">
            ...
            {/* DESCRIPTION */}
            <p className="mt-8 max-w-4xl text-lg leading-9 text-slate-300 lg:text-xl">
            ...
            {/* SEARCH */}
            <div className="mt-12 max-w-3xl rounded-[32px] bg-white/10 p-5 backdrop-blur">

              <div className="flex items-center gap-4 rounded-2xl bg-white px-5 py-5 shadow-xl">
                ...
                <input
                  ...
                  placeholder="Search packages, Umrah, Hajj, Dubai..."
